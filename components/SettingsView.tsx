...
import { SystemSettings, DeviceType, Department, User, DeviceDisplayConfig, AlarmThresholdItem } from '../types';
...
interface SettingsViewProps {
  ...
  onSaveDeviceConfig: (config: DeviceDisplayConfig) => void;
  ...
  return (
    <div className="flex-1 p-6 md:p-8 bg-med-bg text-gray-200 overflow-y-auto">
      ...
      <div className="flex flex-col gap-8 w-full max-w-none">
        <SimulationControl settings={settings} onUpdate={onUpdate} onTriggerAlarm={onTriggerAlarm} />
           ...
           <div className="flex flex-col lg:flex-row min-h-[400px]">
              {activeTab !== 'alarms' ? (
                  ...
                  <AlarmConfigTab 
                    ...
                    onToggleNightMode={() => onUpdate({...settings, nightMode: !settings.nightMode})}
                  />
              )}
           </div>
        </div>
