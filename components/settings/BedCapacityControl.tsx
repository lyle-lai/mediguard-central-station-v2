...
const BedCapacityControl: React.FC<BedCapacityControlProps> = ({ settings, onSaveCapacity, currentDepartment }) => {
  ...
  const deptPrefix = currentDepartment.split(' ')[0] === '重症医学科' ? 'ICU' :
                     currentDepartment.split(' ')[0] === '手术室' ? 'OR' :
                     currentDepartment.split(' ')[0] === '急诊科' ? 'ER' :
                     currentDepartment.split(' ')[0] === '新生儿科' ? 'N' : 'Gen';
